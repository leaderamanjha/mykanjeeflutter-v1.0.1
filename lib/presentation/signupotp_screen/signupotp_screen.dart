...
import 'package:mykanjeeflutter/data/models/registerOtpPost/post_register_otp_post_req.dart';
...
class SignupotpScreen extends GetWidget<SignupotpController> {
  ...
  /// If the call is successful, the function calls the `_onOtpRegisterSuccess()` function.
  /// If the call fails, the function calls the `_onOtpRegisterError()` function.
  ///
