                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildScreenTitle(
                          screenTitle: "Shopping Home - Tab Container".tr,
                          onTapScreenTitle: () => onTapScreenTitle(
                              AppRoutes.shoppingHomeTabContainerScreen),
                        ),
                        _buildScreenTitle(
                          screenTitle: "Product category".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.productCategoryScreen),
                        ),
                        _buildScreenTitle(
                        ...
                        _buildScreenTitle(
                          screenTitle: "Review Cart - Container".tr,
                          onTapScreenTitle: () => onTapScreenTitle(
