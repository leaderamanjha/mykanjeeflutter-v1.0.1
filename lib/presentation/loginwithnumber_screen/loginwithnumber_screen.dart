...
import 'package:mykanjeeflutter/data/models/loginWithUserName/post_login_with_user_name_req.dart';
...
class LoginwithnumberScreen extends GetWidget<LoginwithnumberController> {
  ...
  /// If the call is successful, the function calls the `_onLoginwithUserNameSuccess()` function.
  /// If the call fails, the function calls the `_onLoginwithUserNameError()` function.
  ///
  ...
  Future<void> LoginwithUserName() async {
    ...
    try {
      ...
      _onLoginwithUserNameSuccess();
    } on PostLoginWithUserNameResp {
      _onLoginwithUserNameError();
  ...
  void _onLoginwithUserNameSuccess() {
    Get.toNamed(
  ...
  void _onLoginwithUserNameError() {
    Get.defaultDialog(
